...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2019 a las 04:52:42
...
('Emp1', 'Carlos Rodas', 5000, 'P1', 'D1'),
('Emp2', 'Manuel García', 88000, 'P3', 'D2'),
('Emp3', 'Sthefany Campos', 7000, 'P5', 'D2'),
('Emp4', 'Alexander Sandoval', 3000, 'P6', 'D4');
...
('Nomina2018', '2018-01-01', '2018-12-31', 3456850);
